-- Maquinado: programadora (no operador de taller). Ejecutar en SQL Editor.
...
-- También ejecuta (en el mismo SQL Editor) el archivo:
-- supabase/patch_bodega_complete_maquinado.sql
-- Necesario para "Terminación de maquinado → Armado / Detallado".
