-- Parche: alinea permisos del RPC con el resto de Bodega (cualquier rol is_bodega()).
-- Ejecuta en Supabase → SQL Editor si tu función aún dice «solo admin» o falla con 400 por permisos.
...
-- PostgREST a veces sigue sirviendo la definición vieja hasta recargar caché (evita 400 / «function not found»).
